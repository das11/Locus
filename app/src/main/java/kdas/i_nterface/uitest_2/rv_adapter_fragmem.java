 ...
 */
public class rv_adapter_fragmem extends RecyclerView.Adapter<rv_adapter_fragmem.ViewHolder>{
...
//            i.putExtra("day", pos + 1);
    ...
    public rv_adapter_fragmem(Context context, java.util.List<events> m_events){
        mevents = m_events;
        mcontext = context;
    }
    ...
    @Override
    public rv_adapter_fragmem.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final rv_adapter_fragmem.ViewHolder holder, int position) {
